...
public class ModFluidTypes {
    ...
    public static final ResourceLocation WATER_FLOW_RL = ResourceLocation.fromNamespaceAndPath("minecraft", "block/water_flow");
    public static final ResourceLocation SOY_SAUCE_OVERLAY_RL = ResourceLocation.fromNamespaceAndPath("minecraft", "block/water_overlay");
    ...
    public static final RegistryObject<FluidType> SOY_SAUCE_FLUID_TYPE = FLUID_TYPES.register("soy_sauce_fluid",
            () -> new BaseFluidType(WATER_STILL_RL, WATER_FLOW_RL, SOY_SAUCE_OVERLAY_RL, 0xA1412010, new Vector3f(65f / 255f, 32f / 255f, 16f / 255f),
