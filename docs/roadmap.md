...
* **생칼국수 면**: `밀가루 반죽 (Wheat Dough)` + 칼 ➡️ `생칼국수 면`
* **떡 (Tteok)**: `쌀가루 / 밀가루 반죽` + 칼 ➡️ `떡`
* **다진 생선살**: `날생선 (대구 / 연어 등)` + 칼 ➡️ `다진 생선살`
...
* **닭칼국수**: `생칼국수 면` + `생닭고기` + `대파` + `다진 마늘` + `고추/간장` + `물병` + [그릇] ➡️ **닭칼국수**
* **떡볶이**: `떡` + `어묵` + `대파` + `양배추` + `고추장` + `간장/설탕` + [그릇] ➡️ **떡볶이**
* **제육볶음**: `돼지고기` + `양파` + `대파` + `다진 마늘` + `고추장` + `간장/설탕` + [그릇] ➡️ **제육볶음**
* **돼지국밥 / 된장국밥**: `밥` + `돼지고기/소고기` + `대파` + `다진 마늘` + `된장/고추장` + `액젓` + [그릇] ➡️ **돼지국밥 / 된장국밥**
